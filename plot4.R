...
plot(hpcReq$Date_Time, hpcReq$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "", cex=0.2)

plot(hpcReq$Date_Time, hpcReq$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(hpcReq$Date_Time, hpcReq$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
